        ...
        <div className="flex justify-between items-center gap-8 mb-12">
          <div className="bg-extrablack rounded-xl p-6 border h-[200px] border-white/35 flex-1">
            <div className="flex justify-between items-center mb-4">
              <span className="text-primary font-bold">{t('vitals_measurement.height')}</span>
            ...
            />
            <span className="text-2xl text-gray-400">{heightUnit.toUpperCase()}</span>
          </div>

          <div className="flex-1 flex justify-center">
            <img 
              src="/camera.gif"  // Change this to the correct GIF path
          ...
          <div className="bg-extrablack rounded-xl p-6 border h-[200px] border-white/35 flex-1">
            <div className="flex justify-between items-center mb-4">
              <span className="text-primary font-bold">{t('vitals_measurement.face_id')}</span>
              {faceDetected && <button className="px-3 py-1 rounded bg-gray-700 text-sm">{t('vitals_measurement.login')}</button>}
            </div>
            <div className="text-5xl text-white">{faceDetected ? 'YES' : 'N/A'}</div>
          </div>
        </div>

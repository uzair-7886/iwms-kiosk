...
const VitalsMeasurementGlucose = () => {
    const [glucoseLevel, setGlucoseLevel] = useState('90');
                ...
                <div className="flex justify-between items-center gap-8 mb-12">
                    <div className="bg-extrablack rounded-xl p-6 border h-[200px] border-white/35 flex-1">
                        <div className="flex justify-between items-center mb-4">
                            <span className="text-primary font-bold">{t('glucose.label')}</span>
                        </div>
                        <input
                            type="text"
                            value={glucoseLevel}
                    ...
                    <div className="bg-extrablack rounded-xl p-6 border h-[200px] border-white/35 flex-1">
                        <div className="flex justify-between items-center mb-4">
                            <span className="text-primary font-bold">{t('glucose.card2')}</span>
                        </div>
                        <div className="text-5xl text-white mb-4">{tempCorrection ? tempCorrection : 'N/A'}</div>
                    </div>
                </div>

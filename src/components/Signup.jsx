...
const SignupScreen = () => {
  ...
  return (
    <div className="min-h-screen bg-secondary flex flex-col items-center justify-center p-6">
      <div className="absolute inset-0 opacity-70 mix-blend-multiply pointer-events-none" style={{ backgroundImage: `url('./public/bgPattern.svg')`, backgroundRepeat: 'repeat' }} />
      ...
      <div className="w-full max-w-md text-center">
        ...
        {step === 1 ? (
          <>
            <button className="w-full bg-white p-6 rounded-lg hover:bg-white/90 mb-2">
              <div className="flex flex-col items-center">
                ...
                <span className="text-muted-text text-sm mt-1">Look directly at your front camera to use Face ID</span>
              </div>
            </button>
